...
\includegraphics[width=0.5\textwidth]{src/znMultData/z6MT.png}
\end{figure}

\begin{figure}[h]
\centering
\caption{$Z_{7}^{*}$ Mono Transition Graph}
\includegraphics[width=0.5\textwidth]{src/znMultData/z7MT.png}
\end{figure}

\begin{figure}[h]
\centering
\caption{$Z_{6}^{*}$ Mono Detection Graph}
\includegraphics[width=0.5\textwidth]{src/znMultData/z6MD.png}
\end{figure}

\begin{figure}[h]
\centering
\caption{$Z_{7}^{*}$ Mono Detection Graph}
\includegraphics[width=0.5\textwidth]{src/znMultData/z7MD.png}
\end{figure}
...
\includegraphics[width=0.5\textwidth]{src/znMultData/z6MD_min_dom.png}
\end{figure}
...
\includegraphics[width=0.5\textwidth]{src/znMultData/z7MD_min_dom.png}
\end{figure}

\begin{figure}[h]
\centering
\caption{$Z_{6}^{*}$ Mono Reachability Graph}
\includegraphics[width=0.5\textwidth]{src/znMultData/z6MR.png}
\end{figure}

\begin{figure}[h]
\centering
\caption{$Z_{7}^{*}$ Mono Reachability Graph}
\includegraphics[width=0.5\textwidth]{src/znMultData/z7MR.png}
\end{figure}
