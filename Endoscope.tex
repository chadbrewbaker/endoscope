...
This duality between exponentials and functions gives us a common medium to synthesize algebraic and functional viewpoints.
...
J. Richard B\"{u}chi \cite{buchi1962} further described how we can use either transition (multiplication) tables, transition graphs, or transition trees to give us the viewpoint that best fits a discussion on two variable endofunctions. A quality English translation was made by Sylvia B\"{u}chi, Peter Deussen and Dirk Siefkes \cite{maclane1990}.
